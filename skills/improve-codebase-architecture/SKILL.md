...
Then explore the codebase, using an exploration sub-agent when the harness supports one. Don't follow rigid heuristics — explore organically and note where you experience friction:
